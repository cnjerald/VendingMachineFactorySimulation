...
public class CompoundPriceOverrideView {
    ...
    public CompoundPriceOverrideView() {
        ...
        resetPriceButton = new JButton("Reset Price");
        ...
        public void setResetPriceButtonEventListener(ActionListener actionListener){
        this.resetPriceButton.addActionListener(actionListener);
    }
